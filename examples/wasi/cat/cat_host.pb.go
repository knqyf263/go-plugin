...
type FileCatHandlerFn func(ctx context.Context, runtime wazero.Runtime) error

func (p *FileCatPlugin) Load(ctx context.Context, pluginPath string, handlers ...FileCatHandlerFn) (FileCat, error) {
