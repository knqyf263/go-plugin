...
func (p *KnownTypesTestPlugin) LoadFromBinary(ctx context.Context, reader io.Reader) (knownTypesTest, error) {
...
func (p *EmptyTestPlugin) LoadFromBinary(ctx context.Context, reader io.Reader) (emptyTest, error) {
	b, err := io.ReadAll(reader)
	if err != nil {
		return nil, err
	}
